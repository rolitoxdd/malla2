...
var expresion = /("s[0-9]+":)+|(\[(?:,?[^\[\]])+(?:,\[[^\]]+\])?\])+/g

var file = new Blob([JSON.stringify(data)], {"text/json": "text/json"});
...
//console.log(JSON.stringify(data).match(expresion))
var result = JSON.stringify(data).match(expresion);
